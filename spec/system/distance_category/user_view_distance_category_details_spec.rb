...
describe 'Usuario vê detalhes de categoria de distância' do
 it 'a partir da página inicial no modelo relativo e é admin' do
  ...
  DistanceCategory.create!(min_distance: 100, max_distance: 9900, distance_price: 0.5, delivery_modality: modality)
  DistanceCategory.create!(min_distance: 10000, max_distance: 30000, distance_price: 0.8, delivery_modality: modality)
...
#   modality = DeliveryModality.create!(mod_name: 'Expressa', mod_price: '15')
#   DistanceCategory.create!(min_distance: 0, max_distance: 10, distance_price: 0.5, delivery_modality: modality)
#   DistanceCategory.create!(min_distance: 11, max_distance: 30, distance_price: 0.8, delivery_modality: modality)
