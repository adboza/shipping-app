...
describe 'Usuario edita preços por distância dentro de modalidade de entrega' do
 it 'a partir da página inicial no modelo relativo e vê campos' do
    ...
    DistanceCategory.create!(min_distance: 100, max_distance: 10000, distance_price: 0.5, delivery_modality: modality)
    DistanceCategory.create!(min_distance: 11000, max_distance: 30000, distance_price: 0.8, delivery_modality: modality)
